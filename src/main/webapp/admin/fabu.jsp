...
<META name=GENERATOR content="MSHTML 8.00.7601.17514">
  <script language="JavaScript" src="../admin/scripts/jquery-1.8.3.js"></script>
...
<DIV class=box>
<FORM id="add_action" method="post" enctype="multipart/form-data"  name="sss" action="/admin2/addHouse">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
...
name=floorage></TD></TR>
  ...
  <TR>
    ...
    <TD>区：<SELECT class=text id="district_id" name=district_id><OPTION selected>请选择</OPTION></SELECT>
      街：<SELECT class=text
